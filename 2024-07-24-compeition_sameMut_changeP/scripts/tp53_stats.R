...
tp53clones <- alldat %>%
  ...
  group_by(replicate, corrBlock, year, FAp53block, tp53Clone) %>%
...
write.csv(tp53clones_sampled, glue("/net/gs/vol1/home/huntc10/proj/HomeostaticEpithelium/2024-07-24-competition_sameMut_changeP/dat/tp53clones_sampled_p53Block.csv"), row.names = FALSE)
...
write.csv(tp53clones_sampled_46, glue("/net/gs/vol1/home/huntc10/proj/HomeostaticEpithelium/2024-07-24-competition_sameMut_changeP/dat/tp53clones_sampled_46_p53Block.csv"), row.names = FALSE)
...
write.csv(tp53clones_sampled_summarized, glue("/net/gs/vol1/home/huntc10/proj/HomeostaticEpithelium/2024-07-24-competition_sameMut_changeP/dat/tp53clones_sampled_summarized_p53Block.csv"), row.names = FALSE)
...
# }else{
#   ggsave(glue("/Volumes/gs-vol1/home/huntc10/proj/HomeostaticEpithelium/2024-07-24-competition_sameMut_changeP/results/tp53_tissueProportion.png"), plot, width = 4.5, height = 2, units = "in", dpi = 300)
# }
# 
# q()
# 
