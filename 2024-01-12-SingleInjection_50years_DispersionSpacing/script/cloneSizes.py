...
def plot_parameter_block(block_values, colony_sizes, key):
    ...
    plt.title(f"Colony size distributions of 10 corrected cells in one injection site.\nTime 1 Year")
    #plt.legend()
    plt.savefig(f"/net/gs/vol1/home/huntc10/proj/HomeostaticEpithelium/2024-01-05-SingleInjection_50years_blockingProb/ColonySizeDist_block_{key}.png")
...
for block_val in block_values:
    for timestep in timesteps:
        ...
        for replicate in replicates:
            vis_path=f"/net/feder/vol1/project/HomeostaticEpithelium/dat/2024-01-05-SingleInjection_50years_blockingProb/results/VisFile_block_{block_val}_growth_1.0_sigma_{sigma}_dose_{dose}_correctionTime_1_{replicate}.{timestep}.txt"
...
df['year'] = df['year']/(360*4.5)

df.to_csv('/net/gs/vol1/home/huntc10/proj/HomeostaticEpithelium/2024-01-05-SingleInjection_50years_blockingProb/dat/cloneSizes.csv')
